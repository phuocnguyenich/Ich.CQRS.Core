    ...
    public class Edit
    {
        ...
        public class CommandHandler : RequestHandler<Command>
        {
            ...
            protected override void Handle(Command message)
            {
                ...
                var original = new Domain.Booking { SeatId = booking.SeatId, FlightId = booking.SeatId };
                ...
                if (original.FlightId != booking.FlightId)
                    _rollup.TotalBookingsForFlight(original.FlightId);

                if (original.SeatId != booking.SeatId)
                    _rollup.TotalBookingsForSeat(original.SeatId);
            }
        }
    }
}
